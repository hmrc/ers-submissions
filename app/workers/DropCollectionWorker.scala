...
@Singleton
class DropCollectionWorker @Inject()(mongoComponent: MongoComponent)
                                     (implicit ec: ExecutionContext)
  extends ScheduledService[Unit] with ErsLogger {

  override val jobName: String = "drop-collection-worker"

  private val collectionName = "ErsJsonStoreInfo"
