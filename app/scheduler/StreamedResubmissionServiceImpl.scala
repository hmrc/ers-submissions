...
class StreamedResubmissionServiceImpl @Inject()(
  ...
  override def jobName: String                           = "resubmission-streamed-service"
  val actorSystem: ActorSystem                           = ActorSystem(jobName)
  val scheduledMessage: StreamedResubmissionServiceClass = StreamedResubmissionServiceClass(resubmissionService)
